...
export const backgrounds = [
    { id: 'relaxing', name: 'Relaxing', src: relaxingBg, credit: 'https://unsplash.com/photos/fed622ff2c3b' },
    { id: 'motivating', name: 'Motivating', src: motivatingBg, credit: 'https://unsplash.com/photos/vO9I5nAis0M' },
    { id: 'fireplace', name: 'Fireplace', src: fireplaceBg, credit: 'https://unsplash.com/photos/aAbc_C7PH4Y' },
    { id: 'coffeeshop', name: 'Coffee Shop', src: coffeeShopBg, credit: 'https://unsplash.com/photos/b67a49e012bf' },
    { id: 'irishcoast', name: 'Irish Coast', src: irishCoastBg, credit: 'https://unsplash.com/photos/ddff29c27927' },
];
